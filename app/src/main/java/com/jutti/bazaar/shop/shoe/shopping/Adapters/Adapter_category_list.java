...
public class Adapter_category_list extends RecyclerView.Adapter<Adapter_category_list.MyViewHolder> {
    Context mContext;
   ...
   String user_id = "";
    ...
    public Adapter_category_list(Context context) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        category_Content = Brand_list.Model_CategoryArrayList.get(position);
        ...
        holder.ll_clickable.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // Product_list.brandID=Brand_selction.brand_id.get(position);
                Product_list.categoryID=""+category_Content.getcategory_id();
              //  Product_list.title=Brand_selction.brand_name.get(position);
    ...
    public int getItemCount() {
        return Brand_list.Model_CategoryArrayList.size();
    }
