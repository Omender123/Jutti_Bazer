...
public class Adapter_seller_brand extends RecyclerView.Adapter<Adapter_seller_brand.MyViewHolder> {
    Context mContext;
    ...
    public Adapter_seller_brand(Context context) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.name.setText(Brand_list.seller_name.get(position));
        holder.loc.setText(Brand_list.seller_add.get(position));

        Glide.with(mContext)
                .load(Brand_list.seller_photo.get(position))
                .thumbnail(0.05f)
                .transition(DrawableTransitionOptions.withCrossFade())
                .placeholder(R.drawable.placeholder)
                .into(holder.img);
        if (Brand_list.seller_add.get(position).equals("1")) {
        ...
        holder.ll_clickable.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Product_list.seller_id = Brand_list.seller_id.get(position);
                Product_list.title = Brand_list.seller_name.get(position);
    ...
    public int getItemCount() {
        return Brand_list.seller_id.size();
    }
