...
public class Adapter_products extends RecyclerView.Adapter<Adapter_products.MyViewHolder> {
    Context mContext;
   Model_Products modelcontent;
    SharedPreferences sharedPref;
   ProgressDialog progressDialog;
   String user_id = "";

    public Adapter_products(Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.model_product_home, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        modelcontent = Homefrag.Model_ProductArrayList.get(position);
    ...
    public int getItemCount() {
        return Homefrag.Model_ProductArrayList.size();
    }
